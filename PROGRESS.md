...
- **next_action**: `类型定义与 JSON Schema（T0.2）`
- **completed**: `1 / 35`
- **blockers**: `0`
...
|----|------|------|------|------|--------|------|
| T0.1 | 仓库骨架 | done | 2026-05-01T12:30:00Z | 2026-05-01T12:45:00Z | 078bafd | — |
...
- **备注**：需在 PATH 中包含 Node≥20（本环境 CI 若没有系统 Node，则用官方 tarball/`nvm`）。根 `tsconfig` 启用 `skipLibCheck` — 详见决策日志。
