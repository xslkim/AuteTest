...
|----|------|------|------|------|--------|------|
| T0.1 | 仓库骨架 | done | 2026-05-01T12:05:00Z | 2026-05-01T12:35:00Z | bfcc5fc | — |
...
- artifacts: `package.json`、`package-lock.json`、`tsconfig.json`、`remotion.config.ts`、`bin/autovideo.ts`、`.gitignore`（追加忽略规则）
- 备注：环境中初始无 Node，已通过 apt 安装 Node 20 完成验收。
